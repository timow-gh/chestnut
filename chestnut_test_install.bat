...
set FIND_PACKAGE_TEST_DIR=%REPOSITORY_PARENT_PATH%\chestnut_find_package_test
set FIND_PACKAGE_TEST_BUILD_DIR=%FIND_PACKAGE_TEST_DIR%\chestnut_build
set FIND_PACKAGE_TEST_SOURCE_DIR=.\test\test_install\template_find_package_install_test
set FIND_PACKAGE_TEST_INSTALL_DIR=%FIND_PACKAGE_TEST_DIR%\chestnut_install
